...
export class BookingService {
  ...
  // ✅ Create a booking (snapshot immutable facts + coupon fields)
  async create(dto: CreateBookingDto) {
    ...
    const pooja = await this.prisma.pooja.findUnique({
      ...
      include: { priests: true, categories: true },
    })
  ...
  // ✅ Priest-only filtered list (also used by /booking/my)
  ...
  // ✅ Update (pooja/priest re-validation preserved)
